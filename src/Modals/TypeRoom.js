        ...
        >
            <View>
                ...
                <View style={styles.modalView}>
                    <Button size={"small"} color={"green"} onPress={() => { setOpenChooseModeModal(true) }}>Créer une partie personnalisé</Button>
                    <Button size={"small"} color={"green"} onPress={() => ((setJoinCode(true)))}>Rejoindre une partie</Button>
